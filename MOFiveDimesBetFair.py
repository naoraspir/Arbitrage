...
prog_log_path = "C:/Users/Administrator/Desktop/ScriptLog/Soccer/5Dimes/betfair/Match_Odds/"+config.get_prog_log()
t2 = "C:/Users/Administrator/Desktop/ScriptLog/Soccer/5Dimes/betfair/Match_Odds/"+config.get_omri()
t = "C:/Users/Administrator/Desktop/ScriptLog/Soccer/5Dimes/betfair/Match_Odds/"+config.get_log()
    ...
    for i2, r2 in site_2.drop_duplicates(subset='Event Name', keep='first').iterrows():
        for i1, r1 in site_1.drop_duplicates(subset='Event Name', keep='first').iterrows():
            ...
            if SequenceMatcher(a=r1['Event Name'], b=r2['Event Name']).ratio() >= 0.6:
                time2 = (r2['Date']-timedelta(hours=5)).strftime('%Y-%m-%dT%H:%M:%SZ')
