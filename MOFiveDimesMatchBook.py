...
prog_log_path = "C:/Users/Administrator/Desktop/ScriptLog/Soccer/5Dimes/matchbook/Match_Odds/"+config.get_prog_log()
t2 = "C:/Users/Administrator/Desktop/ScriptLog/Soccer/5Dimes/matchbook/Match_Odds/"+config.get_omri()
t = "C:/Users/Administrator/Desktop/ScriptLog/Soccer/5Dimes/matchbook/Match_Odds/"+config.get_log()
current_dir = r"C:/Users/Administrator/AppData/Roaming/BrowserAutomationStudio/release/5Dimes12AMPMimproved.1"
bookie_url = 'C:/Users/Administrator/Desktop/Scraping (BAS)/Data/5dimes.csv'
log_info = ''
...
def PureCalc(bookie=None, trading=None, exchange=None, headers=None, c_betfair=0, c_matchbook=0, log_times=None,
    ...
    b, c = bookie.iloc[0], bookie.iloc[1]

    temp = bookie.iloc[0].copy()
    bookie.iloc[0] = c
    bookie.iloc[1] = temp
    ...
    for i2, r2 in site_2.drop_duplicates(subset='Event Name', keep='first').iterrows():
        for i1, r1 in site_1.drop_duplicates(subset='Event Name', keep='first').iterrows():
            ...
            if SequenceMatcher(a=r1['Event Name'], b=r2['Event Name']).ratio() >= 0.6:
                time2 = time2 = (datetime.fromisoformat(r2['Date'][:-1])-timedelta(hours=5)).strftime('%Y-%m-%dT%H:%M:%SZ')
